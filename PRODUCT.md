...
delegated: static HTML/CSS primero (mock visual → sitio), stack definitivo se confirma al pasar de mock a producción.

## Users

Conductores y dueños de vehículos en CABA / AMBA que necesitan batería o carga **ya** — a menudo varados, apurados, buscando por Google/Maps o WhatsApp. También vecinos del local (Viamonte 2031, Balvanera) que van al local.

## Product Purpose

Sitio / mockup de **Baterías CABA** para que alguien con urgencia entienda en segundos qué hacen, que están **24 hs**, dónde están, y contacte por WhatsApp o vaya al local. No es un e-commerce complejo: es confianza local + acción rápida.

## Positioning

Comercio de barrio en CABA: **venta y carga de baterías para auto**, atención continua (**24 horas**), contacto directo por WhatsApp. Sin marca elaborada hoy; la web debe sentirse clara, cercana y resolutiva — no cadena corporativa ni “startup de movilidad”.
