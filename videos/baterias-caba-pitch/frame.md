...
description: >
  ...
  Inter Tight in lowercase weight 900 treated as graphic primitive, IBM Plex Mono chrome (uppercase,
...
colors:
  # Brand semantics restored (asphalt ground, ink type, signal orange).
  ink-black: "#0E0F10"
  ink-black-alt: "#16181A"
  fire-orange: "#FF5A1F"
  cream: "#F2F1EC"
  cream-muted: "rgba(242,241,236,0.62)"
  cream-hint: "rgba(242,241,236,0.38)"
  border-dark: "rgba(242,241,236,0.12)"
  wa-green: "#25D366"
  ink-on-orange-muted: "rgba(14,15,16,0.75)"
  ink-on-orange-hint: "rgba(14,15,16,0.55)"
  ink-on-orange-faint: "rgba(14,15,16,0.40)"
  ink-on-orange-border: "rgba(14,15,16,0.20)"

typography:
  # Brand: Saira display + Inter Tight body (landing lock).
  body:    { fontFamily: "Inter Tight", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "Inter Tight", cqw: 1.6, weight: 500, lineHeight: 1.5 }
  caption: { fontFamily: "Inter Tight", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  label:   { fontFamily: "Inter Tight", cqw: 0.72, weight: 600, tracking: "0.12em", upper: true }
  h3:      { fontFamily: "Saira", cqw: 2.8, weight: 600, lineHeight: 1.2 }
  quote-text:{ fontFamily: "Saira", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em" }
  h2:      { fontFamily: "Saira", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em" }
  stat-value:{ fontFamily: "Saira", cqw: 5.5, weight: 800, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Saira", cqw: 7.5, weight: 800, lineHeight: 0.9, tracking: "-0.03em" }
  fadelist-item:{ fontFamily: "Saira", cqw: 7.5, weight: 800, lineHeight: 1.0, tracking: "-0.03em" }
  quote-mark:{ fontFamily: "Saira", cqw: 10.0, weight: 800, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Saira", cqw: 10.5, weight: 800, lineHeight: 0.9, tracking: "-0.04em" }
  display: { fontFamily: "Saira", cqw: 13.0, weight: 800, lineHeight: 0.88, tracking: "-0.04em" }
...
- **Fonts** — already set to **Inter Tight** (display) / **Saira** (body); ignore any preset font name lingering in prose.
...
text and becomes graphic primitive.** Inter Tight `display` at 13cqw puts a single lowercase word
...
**Inter Tight** carries every text role from display to body — expressive range from weight (400–900)
...
- **Massive lowercase Inter Tight 900**, negative-tracked, as graphic primitive (display 13cqw).
...
Two ramps. The **reading ramp** (Inter Tight body 1.2cqw, mono label 0.72cqw) carries copy + chrome; the
**display ramp** (Inter Tight `h2` 4.5cqw → `display` 13cqw, weight 700–900) carries every statement.
...
- **Inter Tight display is lowercase, weight 700–900, negative-tracked** (−0.04em largest, −0.02em h2). **Mono chrome is uppercase, 0.1em+.** No italic, no underline, no uppercase display.
...
Inter Tight `display` (13cqw) lowercase in ink, left-anchored, over a small ink rule stub + mono kicker; a
Inter Tight lead line beneath in 75% ink. **Chrome** mono catalogue number top-left, mono meta top-right
...
**Ground** ink-black. **Composes** kicker, display. **Focal** a 2–4 word Inter Tight `display`/`h1`
...
row of three top-border-only stat-cards — big Inter Tight-900 numeral in `{colors.fire-orange}`, Inter Tight
...
**Ground** ink-black. **Composes** fadelist (3 stacked Inter Tight-900 words at 1.0/0.5/0.22), fadelist-title.
...
Inter Tight `quote-text` (700, lowercase) at ≤78cqw under an oversized fire-orange `quote-mark` (10cqw,
...
- Set every Inter Tight display in **lowercase weight 900**, negative-tracked — the system's signature.
...
- Never uppercase Inter Tight display; never add a second accent color.
...
- No serif companion; chrome is never Inter Tight.
...
- **Type** — Inter Tight lowercase 900 negative-tracked, fit-to-measure; mono chrome uppercase 0.14em; ≥1.4cqw floor.
...
- **Inter Tight + IBM Plex Mono via Google Fonts**; Noto Sans SC is the CJK fallback (the lowercase-display signal has no CJK equivalent — the two-register color system carries the identity, per the source).
